...
function getInfo(atomic_number) {
  let info = DbData.elements.find(
    (element) => element.number === atomic_number
  );
  //   console.log(info);
  if (info) {
    return info;
